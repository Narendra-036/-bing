...
for _ in range(3):
    ...
    new_id=''.join(random.choice(letters) for i in range(10))+"@hotmail.com"
    print(new_id)
    ...
    f_name.send_keys("teddy")
    l_name=driver.find_element("id","LastName")
    l_name.send_keys("chor")
    btn=driver.find_element("id","iSignupAction")
    btn.click()
    time.sleep(2)
    ...
    # sel_con=Select(driver.find_element("id","wlspispHIPCountrySelectf585c9250aef44b8996b6e8399f35cc6"))
    # sel_con.select_by_value("SE")
    # sel_number=driver.find_element("id","wlspispHIPPhoneInputb46be880fa964a6ab33c0eb640d068cf")
    # sel_number.send_keys("731298793")
    # btn=driver.find_element("id","wlspispHipControlButtonsContainer")
    # btn.click()
